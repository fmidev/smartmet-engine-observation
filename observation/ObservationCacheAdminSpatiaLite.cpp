...
{
  return std::pair<boost::posix_time::ptime, boost::posix_time::ptime>(boost::posix_time::not_a_date_time, boost::posix_time::not_a_date_time);
}
...
ObservationCacheAdminSpatiaLite::getLatestFlashTime(
    const boost::shared_ptr<ObservationCache>& cache) const
{
