...
Spine::TimeSeries::TimeSeriesVectorPtr SpatiaLiteDatabaseDriverInterface::values(
...
FlashCounts SpatiaLiteDatabaseDriverInterface::getFlashCount(
    const boost::posix_time::ptime &starttime,
    const boost::posix_time::ptime &endtime,
...
void SpatiaLiteDatabaseDriverInterface::getStations(Spine::Stations &stations,
...
void SpatiaLiteDatabaseDriverInterface::getStationsByBoundingBox(Spine::Stations &stations,
                                                                 const Settings &settings) const
{
