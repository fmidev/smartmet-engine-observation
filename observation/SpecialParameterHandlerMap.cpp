...
using SmartMet::Engine::Observation::SpecialParameterHandlerMap;

Spine::TimeSeries::Value
SpecialParameterHandlerMap::operator() (
    const std::string& param_name,
    const SpecialParameterHandlerMap::Args& args) const
{
...
SpecialParameterHandlerMap::SpecialParameterHandlerMap()
    : tf(Fmi::TimeFormatter::create("iso"))
{
    handler_map[COUNTRY_PARAM] =
        [](const SpecialParameterHandlerMap::Args& d) -> Spine::TimeSeries::Value
        {
    ...
    handler_map[UTC_PARAM] =
        [this](const SpecialParameterHandlerMap::Args& d) -> Spine::TimeSeries::Value
        {
...
SpecialParameterHandlerMap::Args::get_solar_position() const
{
    if (!solar_position) {
...
SpecialParameterHandlerMap::Args::get_solar_time() const
{
    if (!solar_time) {
        solar_time.reset(
...
SpecialParameterHandlerMap::Args::get_lunar_time() const
{
    if (!lunar_time) {
        lunar_time.reset(
