...
{
DBRegistryConfig::DBRegistryConfig(const std::shared_ptr<Spine::ConfigBase>& config)
{
  try
  {
    ...
    for (int i = 0; i < numberOfFields; i++)
    {
      ...
      std::vector<std::string> valueTypeList{
          "int", "uint", "float", "double", "string", "Fmi::DateTime"};
